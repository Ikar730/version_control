...
```sh
git config --global user.email "gewehrr@gmail.com"
```
...
```sh
git commit -m "Your coment about commit"
``````
...
git log -p
```
Просмотреть в кратце и в линию
```sh
git log --oneline
```
Со всеми изменениями и графическим отображением 
```sh
